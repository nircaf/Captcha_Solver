...
data_dir = Path('C:\\NeuroBrave\\Scrapy\\kaggle_ml\\Data_run')
...
def training_model(train_data_generator,valid_data_generator):
...
def predicting(prediction_model,valid_data_generator):
...
def loading_model(valid_data_generator):
    model = keras.models.load_model('C:\\NeuroBrave\\Scrapy\\kaggle_ml\\Gold_1070')

    prediction_model = keras.models.Model(model.get_layer(name='input_data').input,
                                          model.get_layer(name='dense2').output)

    predicting(prediction_model, valid_data_generator)

if __name__ == "__main__":

    loading_model(valid_data_generator)
